...
public class demop implements demopConstants {
  public static int NicsLU_Initialize(SNicsLU nicslu) {
    return demopJNI.NicsLU_Initialize(SNicsLU.getCPtr(nicslu), nicslu);
  }
  ...
  public static int NicsLU_DestroyThreads(SNicsLU nicslu) {
    return demopJNI.NicsLU_DestroyThreads(SNicsLU.getCPtr(nicslu), nicslu);
  }

  public static int NicsLU_Analyze(SNicsLU nicslu) {
    return demopJNI.NicsLU_Analyze(SNicsLU.getCPtr(nicslu), nicslu);
  }

  public static int NicsLU_Factorize(SNicsLU nicslu) {
    return demopJNI.NicsLU_Factorize(SNicsLU.getCPtr(nicslu), nicslu);
  }

  public static int NicsLU_ReFactorize(SNicsLU nicslu, SWIGTYPE_p_real__t ax) {
    return demopJNI.NicsLU_ReFactorize(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(ax));
  }

  public static int NicsLU_Factorize_MT(SNicsLU nicslu) {
    return demopJNI.NicsLU_Factorize_MT(SNicsLU.getCPtr(nicslu), nicslu);
  }

  public static int NicsLU_ReFactorize_MT(SNicsLU nicslu, SWIGTYPE_p_real__t ax) {
    return demopJNI.NicsLU_ReFactorize_MT(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(ax));
  }

  public static int NicsLU_Solve(SNicsLU nicslu, SWIGTYPE_p_real__t rhs) {
    return demopJNI.NicsLU_Solve(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(rhs));
  }

  public static int NicsLU_SolveFast(SNicsLU nicslu, SWIGTYPE_p_real__t rhs) {
    return demopJNI.NicsLU_SolveFast(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(rhs));
  }
  ...
  public static int NicsLU_Throughput(SNicsLU nicslu, SWIGTYPE_p_real__t thr) {
    return demopJNI.NicsLU_Throughput(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(thr));
  }

  public static int NicsLU_Flops(SNicsLU nicslu, SWIGTYPE_p_real__t flops) {
    return demopJNI.NicsLU_Flops(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(flops));
  }

  public static int NicsLU_ThreadLoad(SNicsLU nicslu, long threads, SWIGTYPE_p_p_real__t thread_flops) {
    return demopJNI.NicsLU_ThreadLoad(SNicsLU.getCPtr(nicslu), nicslu, threads, SWIGTYPE_p_p_real__t.getCPtr(thread_flops));
  }

  public static int NicsLU_DumpA(SNicsLU nicslu, SWIGTYPE_p_p_real__t ax, SWIGTYPE_p_p_uint__t ai, SWIGTYPE_p_p_uint__t ap) {
    return demopJNI.NicsLU_DumpA(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_p_real__t.getCPtr(ax), SWIGTYPE_p_p_uint__t.getCPtr(ai), SWIGTYPE_p_p_uint__t.getCPtr(ap));
  }
  ...
  public static int NicsLU_DumpLU(SNicsLU nicslu, SWIGTYPE_p_p_real__t lx, SWIGTYPE_p_p_uint__t li, SWIGTYPE_p_p_size_t lp, SWIGTYPE_p_p_real__t ux, SWIGTYPE_p_p_uint__t ui, SWIGTYPE_p_p_size_t up) {
    return demopJNI.NicsLU_DumpLU(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_p_real__t.getCPtr(lx), SWIGTYPE_p_p_uint__t.getCPtr(li), SWIGTYPE_p_p_size_t.getCPtr(lp), SWIGTYPE_p_p_real__t.getCPtr(ux), SWIGTYPE_p_p_uint__t.getCPtr(ui), SWIGTYPE_p_p_size_t.getCPtr(up));
  }

  public static int NicsLU_ConditionNumber(SNicsLU nicslu, SWIGTYPE_p_real__t cond) {
    return demopJNI.NicsLU_ConditionNumber(SNicsLU.getCPtr(nicslu), nicslu, SWIGTYPE_p_real__t.getCPtr(cond));
  }
